/****************************************************************************
** Meta object code from reading C++ file 'vectorwidget.h'
**
** Created: Fri Sep 4 17:31:26 2009
...
#error "The header file 'vectorwidget.h' doesn't include <QObject>."
...
static const char qt_meta_stringdata_VectorWidget[] = {
    "VectorWidget\0\0step()\0reset()\0"
    "show_wave1(int)\0show_wave2(int)\0"
};

const QMetaObject VectorWidget::staticMetaObject = {
    { &QwtPlot::staticMetaObject, qt_meta_stringdata_VectorWidget,
      qt_meta_data_VectorWidget, 0 }
};
